// src/components/scoring/FormDecimal.tsx
...
export const FormDecimal: React.FC<Props> = ({
  rule,
  index = -1,
  onDelete,
  isOpen,
      ...
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-screen overflow-y-auto p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900">
            {isEdit ? 'Modifier la règle - Nombre décimal' : 'Ajouter une règle - Nombre décimal'}
          </h3>
          <button
            onClick={onClose}
        ...
        <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-800">
            <strong>Note :</strong> Saisissez une plage (ex: 10 à 20) ou une valeur unique (ex: 15.5).
          </p>
        </div>
